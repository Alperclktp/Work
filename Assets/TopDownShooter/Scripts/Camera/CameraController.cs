...
namespace TopDownShooter.Camera
{
    public class CameraController : MonoBehaviour
    {
        ...
        private void CameraMovementFollow()
        {
            ...
            Vector3 offset = (_cameraTransform.right * _cameraSettings.PositionOffset.x) + (_cameraTransform.up *
                _cameraSettings.PositionOffset.y) + (_cameraTransform.forward * _cameraSettings.PositionOffset.z); 

            _cameraTransform.position = Vector3.Lerp(_cameraTransform.position,
                _targetTransform.position + offset, Time.deltaTime *
